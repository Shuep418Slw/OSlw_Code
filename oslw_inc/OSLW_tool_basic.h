...
#define OSLW_TOOL_DLIST_NODE_CONNECT(P1,P2) 	(P1)->con.pNext=(OSlwToolDListNodeConnectSTU *)(P2);/*(Ver.=0.97)尾部的下一个为新的*/\
(P2)->con.pLast = (OSlwToolDListNodeConnectSTU *)(P1);/*(Ver.=0.97)新节点的上一个为原来尾部*/
...
#define OSLW_TOOL_DLIST_NODE_DELECT(P) 			(P)->con.pLast->pNext=(P)->con.pNext;/*(Ver.=0.97)上一个的下一个为下一个*/\
(P)->con.pNext->pLast = (P)->con.pLast;/*(Ver.=0.97)下一个的上一个为上一个*/
